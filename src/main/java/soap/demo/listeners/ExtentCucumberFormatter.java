...
public class ExtentCucumberFormatter implements Reporter, Formatter {
	/*static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "\\src\\main\\java\\com\\DemoProject\\Reports\\"
				+ formater.format(calendar.getTime()) + "_Qentelli_Report.html", false);
	}*/
